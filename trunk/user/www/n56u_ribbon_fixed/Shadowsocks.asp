								...
								<div class="box well grad_colour_dark_blue">
									...
									<div class="round_bottom">
										...
										<div><span style="color:#E53333;">注意:</span></div>
													...
													<div><span style="color:#E53333;">运行状态不会实时更新，启动节点后<input type="button" id="btn_reconnect" class="btn btn-info" value="刷新页面" onclick="window.location.reload();" tabindex="1"> 获取运行状态</span></div>
												</div>
